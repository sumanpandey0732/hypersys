        ...
        <div className="flex flex-col h-full w-[280px]">
          ...
          <div className="p-4 border-b border-sidebar-border">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={onToggleCollapse}
                className="p-2 rounded-lg hover:bg-sidebar-accent transition-colors lg:block hidden"
              >
          ...
          <div className="p-4">
            <Button
              ...
              className="w-full bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 justify-start gap-3 py-5"
            >
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin px-3 pb-4">
            ...
            <div className="space-y-1">
              ...
              {conversations.length === 0 && (
                <p className="text-sm text-sidebar-foreground/40 text-center py-8">
          ...
          <div className="p-4 border-t border-sidebar-border">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-sidebar-accent/30">
              ...
              <button
                ...
                className="p-2 rounded-lg hover:bg-destructive/20 text-sidebar-foreground/60 hover:text-destructive transition-colors"
                title="Sign out"
              >
